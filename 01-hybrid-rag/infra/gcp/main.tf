...
locals {
  ...
  elasticsearch_url = "https://elasticsearch.internal:9200" # Placeholder; replace with self-hosted or managed ES
...
resource "google_service_account" "api" {
  ...
  display_name = "Hybrid RAG API service account"
}
...
resource "google_compute_backend_service" "api" {
  ...
  description = "Backend service for Hybrid RAG API"
