...
variable "domain" {
  description = "Public domain name for the Corrective RAG API"
  type        = string
}
...
variable "app_image" {
  description = "Docker image for the Corrective RAG FastAPI backend"
  type        = string
  default     = "rag-foundry/corrective-rag-backend:latest"
}
