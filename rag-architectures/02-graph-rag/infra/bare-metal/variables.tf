...
variable "domain" {
  description = "Public domain name for the Graph RAG API"
  type        = string
}
...
variable "app_image" {
  description = "Docker image for the Graph RAG FastAPI backend"
  type        = string
  default     = "rag-foundry/graph-rag-backend:latest"
}
