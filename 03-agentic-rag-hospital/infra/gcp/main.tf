...
locals {
  ...
  qdrant_url        = "https://storage.googleapis.com/${google_storage_bucket.qdrant.name}"
  ...
  common_env = {
    ...
    DENSE_COLLECTION           = "agentic_rag_dense"
    SPARSE_INDEX               = "agentic_rag_sparse"
    DEFAULT_TOP_K              = "5"
...
resource "google_service_account" "api" {
  ...
  display_name = "Agentic RAG Hospital API service account"
}
...
resource "google_compute_backend_service" "api" {
  ...
  description = "Backend service for Agentic RAG Hospital API"
