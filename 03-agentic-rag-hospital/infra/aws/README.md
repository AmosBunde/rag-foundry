# Agentic RAG Hospital — AWS Terraform Module

Production-ready AWS infrastructure for the Agentic RAG Hospital backend using ECS Fargate, RDS Postgres, ElastiCache Redis, S3, ALB, CloudFront, Secrets Manager, and CloudWatch.
...
terraform apply \
  ...
  -var="api_image=123456789012.dkr.ecr.us-east-1.amazonaws.com/agentic-rag-hospital-backend:latest" \
